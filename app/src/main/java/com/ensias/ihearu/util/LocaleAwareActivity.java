...
// A base for all of the activities that automatically recreates itself when the language changes
...
public abstract class LocaleAwareActivity extends AppCompatActivity {
    ...
    private void setLocale() {
        ...
        try {
            sectionsLocale = Sections.setLocale(LocaleUtils.getAvailableLocalesFromPreferences(this));
