...
public final class PermissionUtils {
    ...
    //PackageManager.PERMISSION_GRANTED}, false otherwise. So returns true if the provided grant results array is empty.
    ...
    //return an array of the permissions the provided skill info requires. If the provided skill info is null, an empty array is returned.
    ...
    //return comma-separated list of the localized labels of all of the permissions the provided skill info requires
